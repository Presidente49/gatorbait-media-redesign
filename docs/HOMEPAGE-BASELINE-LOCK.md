...
- Newsroom loader custom embed: `fdc2127a-845a-4d02-b711-438f1a4a86ce`
  - live verified revision: `51`
  - required state: **ENABLED**
- Revision 51 preserves the V1 production baseline and adds a query-parameter-only Masthead V2 preview lane (`?gbm_preview=masthead-v2`). The V2 preview is not the default homepage and does not unlock or replace the baseline until the verification gate passes.
