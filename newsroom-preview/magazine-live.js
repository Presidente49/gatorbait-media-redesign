...
function build(posts){
 ...
 var buddyIndex=posts.findIndex(function(p){return /buddy martin/i.test(p.who||'')});var lead=buddyIndex>=0?posts[buddyIndex]:posts[0];var ordered=posts.filter(function(p){return p!==lead});var lines=ordered.slice(0,3),inside=ordered.slice(3,9);
